...
✅ **12 Subjects** - Math, English, Physics, Chemistry, Biology, Economics, etc.
...
3. Type: `teachmaster` or `domislink-academy`
4. Your URL: `teachmaster.netlify.app`
...
| Plan | Price | Duration |
|------|-------|----------|
| Free | ₦0 | Forever (2 subjects only) |
